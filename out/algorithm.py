...
class Game:
    def __init__(self, state: MatchState):
        ...
        self.rounds_played = (
            state.matchHistory[-1].gameHistory if state.matchHistory else []
        )
...
def get_valid_tricks_one(
    cards: list[Card], trick_to_beat: list[Card]
) -> list[list[Card]]:
...
def calculate_trick_strength_one(
    trick: list[Card], possible_tricks: list[list[Card]]
) -> float:
    num_beaten = sum(
        1
        for opponent_trick in possible_tricks
        if is_trick_stronger(opponent_trick, trick)
    )
...
def one_card_trick(state: Game) -> list[Card]:
    ...
    trick_probabilities = [
        calculate_trick_strength_one(trick, possible_tricks) for trick in valid_tricks
    ]
    print(valid_tricks)
...
def calculate_trick_strength_two(
    trick: list[Card], possible_tricks: list[list[Card]]
) -> float:
    num_beaten = sum(
        1
...
def two_card_trick(state: Game) -> list[Card]:
    ...
    # return []
    trick_probabilities = [
        calculate_trick_strength_two(trick, possible_tricks) for trick in valid_tricks
    ]
    print(valid_tricks)
    print(trick_probabilities)
...
def calculate_trick_strength_three(
    trick: list[Card], possible_tricks: list[list[Card]]
) -> float:
    num_beaten = sum(
        1
...
def three_card_trick(state: Game) -> list[Card]:
    ...
    # return []
    trick_probabilities = [
        calculate_trick_strength_three(trick, possible_tricks) for trick in valid_tricks
    ]
    print(valid_tricks)
    print(trick_probabilities)
